...
lastmod: 2020-11-23
draft: false
description: "本文介绍了布隆过滤器的原理，并用Java语言实现了简单的布隆过滤器。"
tags:
- bloomfilter
...
<!-- ![布隆过滤器示意图](/img/bloom-filter-1.png) -->

{{< img src="/img/bloom-filter-1.png" title="布隆过滤器示意图" width="500px" position="center" >}}
...
<!-- ![布隆过滤器hash计算](/img/bloom-filter-2.png) -->

{{< img src="/img/bloom-filter-2.png" title="布隆过滤器hash计算" width="500px" position="center" >}}
...
---
[点击查看原文](https://github.com/Snailclimb/JavaGuide/blob/master/docs/dataStructures-algorithms/data-structure/bloom-filter.md)
