...
lastmod: 2020-11-24
draft: false
description: "此文总结了redis相关的基础性知识体系，但不包括redis主从、哨兵、集群相关内容"
tags:
- redis
...
![](/img/redis-file-event-handler.png)
...
---
[点击查看原文](https://github.com/Snailclimb/JavaGuide/blob/master/docs/database/Redis/redis-all.md)
